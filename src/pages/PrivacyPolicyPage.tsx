export function PrivacyPolicyPage({ onBack }: { onBack: () => void }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e2d3d] to-[#0f172a] pb-12">
      <div className="px-4 pt-6">
        <div className="max-w-lg mx-auto">
          ...
          <h1 className="text-white text-2xl font-bold mb-6">Privacy Policy</h1>
          <div className="space-y-6 text-white/60 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-white font-semibold text-base mb-2">Children's data</h2>
            ...
            <section>
              <h2 className="text-white font-semibold text-base mb-2">How we use data</h2>
